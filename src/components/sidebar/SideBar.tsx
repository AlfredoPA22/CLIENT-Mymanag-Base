...
const SidebarMenu = ({
  ...
  if (fixed) {
    return (
      <div className="w-64 h-full shadow-md flex flex-col">
        <SidebarContent
  ...
  return (
    <Sidebar
      ...
      style={{ background: "#f1222", zIndex: 999 }}
      showCloseIcon
    >
      <SidebarContent
        handleNavigate={handleNavigate}
...
const SidebarContent = ({
  ...
  return (
    <>
      ...
      <img src={logo} alt="logo" className="w-[80px] h-[70px] mb-2 rounded-full" />
      </div>
      ...
      <nav className="flex flex-col gap-2 px-4 flex-grow">
        ...
        <button
          ...
          className="flex items-center gap-3 py-3 px-4 rounded-lg text-sm font-semibold text-red-600 hover:bg-red-100 transition-all duration-300 mt-auto mb-5"
        >
