...
// import { CREATE_PRODUCT_TRANSFER } from "../../../graphql/mutations/ProductTransfer";
...
//     variables: { type: codeType.PRODUCT_TRANSFER },
//     fetchPolicy: "network-only",
//   });

//   const { listWarehouse } = useWarehouseList();

//   const [selectedOriginWarehouse, setSelectedOriginWarehouse] =
...
//     const { data } = await createPurchaseOrder({ variables: values });
